...
const Profile = ({ navigation }) => {
    ...
    return (
        <View style={ styles.container }>
            ...
            <Text style={ styles.text }>Waga: { actualProfile && actualProfile.weight }</Text>
            <Text style={ styles.text }>Klatka piersiowa: { actualProfile && actualProfile.chest }cm</Text>
            <Text style={ styles.text }>Biceps: { actualProfile && actualProfile.biceps }cm</Text>
            <Text style={ styles.text }>Obwód pasa: { actualProfile && actualProfile.stomach }cm</Text>
            <Text style={ styles.text }>Obwód uda: { actualProfile && actualProfile.legSize }cm</Text>
            <TouchableOpacity
                style={ styles.button }
